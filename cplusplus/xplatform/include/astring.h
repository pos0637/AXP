...
#define ASCII_CHAR_MAX      (0x7F)       // ASCII字符上限
    ...
    public:
            ...
            IN Int32 length)
        {
            ...
            ret->SetUsed((length + 1) * sizeof(WChar));
            ...
            IN CONST Sp<String> & src)
        {
            ...
            ::memcpy(data, src->GetPayload(), used);
            ret->SetUsed(used);
    ...
    public:
            ...
            IN CONST Int32 length) CONST
        {
            ...
            ret->SetUsed((used + len + 1) * sizeof(WChar));
        ...
        Int32 Length() CONST
        {
            if (mUsed / sizeof(WChar) < 1)
                return 0;
            else
                return (mUsed / sizeof(WChar) - 1);
        }
    ...
    private:
            ...
            IN Int32 length)
        {
            ...
            obj->mUsed = 0;
            obj->mCapacity = sizeof(WChar) * length;
